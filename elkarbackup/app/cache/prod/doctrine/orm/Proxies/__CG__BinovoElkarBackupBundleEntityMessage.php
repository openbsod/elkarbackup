...
class Message extends \Binovo\ElkarBackupBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Binovo\\ElkarBackupBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'Binovo\\ElkarBackupBundle\\Entity\\Message' . "\0" . 'from', '' . "\0" . 'Binovo\\ElkarBackupBundle\\Entity\\Message' . "\0" . 'to', '' . "\0" . 'Binovo\\ElkarBackupBundle\\Entity\\Message' . "\0" . 'message', 'dateTime');
        }
