...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bnvloggerhandler' => 'getBnvloggerhandlerService',
            'bnvtwigdebug' => 'getBnvtwigdebugService',
            'bnvtwigextension' => 'getBnvtwigextensionService',
            'bnvweblogger' => 'getBnvwebloggerService',
            'bnvwebloggerformatter' => 'getBnvwebloggerformatterService',
            'bnvwebuserloggerprocessor' => 'getBnvwebuserloggerprocessorService',
            ...
            'loginlistener' => 'getLoginlistenerService',
            ...
            'security.firewall.map.context.publickey' => 'getSecurity_Firewall_Map_Context_PublickeyService',
            ...
            'streamhandler' => 'getStreamhandlerService',
            'swiftmailer.email_sender.listener' => 'getSwiftmailer_EmailSender_ListenerService',
            'swiftmailer.mailer.default' => 'getSwiftmailer_Mailer_DefaultService',
            'swiftmailer.mailer.default.transport' => 'getSwiftmailer_Mailer_Default_TransportService',
            'tahoe' => 'getTahoeService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BinovoElkarBackupBundle', ($this->targetDirs[2].'/Resources/BinovoElkarBackupBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BinovoElkarBackupBundle', ($this->targetDirs[3].'/src/Binovo/ElkarBackupBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BinovoElkarTahoeBundle', ($this->targetDirs[2].'/Resources/BinovoElkarTahoeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BinovoElkarTahoeBundle', ($this->targetDirs[3].'/src/Binovo/ElkarTahoeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /*
     * Gets the 'bnvloggerhandler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarBackupBundle\Logger\LoggerHandler A Binovo\ElkarBackupBundle\Logger\LoggerHandler instance
     */
    protected function getBnvloggerhandlerService()
    {
    ...
    /*
     * Gets the 'bnvtwigextension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarBackupBundle\Twig\Extension A Binovo\ElkarBackupBundle\Twig\Extension instance
     */
     ...
     */
    protected function getBnvwebloggerService()
    {
        $this->services['bnvweblogger'] = $instance = new \Symfony\Bridge\Monolog\Logger('BnvWeb');

        $instance->pushProcessor($this->get('bnvwebuserloggerprocessor'));
        $instance->pushHandler($this->get('streamhandler'));
        $instance->pushHandler($this->get('bnvloggerhandler'));

        return $instance;
    }

    /*
     * Gets the 'bnvwebloggerformatter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBnvwebloggerformatterService()
    {
...
');
    ...
    /*
     * Gets the 'bnvwebuserloggerprocessor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarBackupBundle\Logger\WebUserLoggerProcessor A Binovo\ElkarBackupBundle\Logger\WebUserLoggerProcessor instance
     */
    protected function getBnvwebuserloggerprocessorService()
    {
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'elkarbackup', 'user' => 'elkarbackup', 'password' => 'elkarbackup', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.5, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager59381748d9c4f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager59381748d9c4f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_59381748d9c4f.php');

        $a = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Binovo/ElkarBackupBundle/Entity'))), 'Binovo\\ElkarBackupBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BinovoElkarBackupBundle' => 'Binovo\\ElkarBackupBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager59381748d9c4f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($c, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d685ac696cfcabf0fbd31f052e06d60dd8c528d4429726a1523732f0e2a548b6');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('security.interactive_login', array(0 => 'loginlistener', 1 => 'onSecurityInteractivelogin'), 0);
        ...
        $instance->addSubscriberService('kernel.listener.localelistener', 'Binovo\\ElkarBackupBundle\\Listener\\LocaleListener');
    ...
    /*
     * Gets the 'kernel.listener.localelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarBackupBundle\Listener\LocaleListener A Binovo\ElkarBackupBundle\Listener\LocaleListener instance
     */
    ...
    /*
     * Gets the 'loginlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarBackupBundle\Listener\LoginListener A Binovo\ElkarBackupBundle\Listener\LoginListener instance
     */
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Binovo\\ElkarBackupBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js|setlocale)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.publickey' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/publickey/get$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    /*
     * Gets the 'security.firewall.map.context.publickey' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_PublickeyService()
    {
        return $this->services['security.firewall.map.context.publickey'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/publickey/get');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/[0-9]+/job/[0-9]+/run');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/users');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/params');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/repositorybackupscript');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/publickey/generate');
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administrators')), 'secured_area', $a, $c), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $q, 'secured_area', $s, $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '59381748bd52b1.61335826', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $q, '/login', false), NULL, NULL, $a, false));
    }
    ...
    /*
     * Gets the 'streamhandler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /*
     * Gets the 'tahoe' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Binovo\ElkarTahoeBundle\Utils\TahoeBackup A Binovo\ElkarTahoeBundle\Utils\TahoeBackup instance
     */
    protected function getTahoeService()
    {
        return $this->services['tahoe'] = new \Binovo\ElkarTahoeBundle\Utils\TahoeBackup($this->get('bnvweblogger'), '/var/lib/elkarbackup');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('bnvtwigdebug'));
        $instance->addExtension($this->get('bnvtwigextension'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'JMSAopBundle', 9 => 'JMSDiExtraBundle', 10 => 'JMSSecurityExtraBundle', 11 => 'BinovoElkarBackupBundle', 12 => 'BinovoElkarTahoeBundle', 13 => 'KnpMenuBundle', 14 => 'KnpPaginatorBundle', 15 => 'DoctrineMigrationsBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('warning_load_level', 0.80000000000000004);
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'BinovoElkarBackupBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'backup_dir' => '/var/spool/elkarbackup/backups',
            'public_key' => '/var/lib/elkarbackup/.ssh/id_rsa.pub',
            'max_log_age' => 'P1Y',
            'tmp_dir' => '/tmp',
            'rsnapshot' => '/usr/local/bin/rsnapshot',
            'warning_load_level' => 0.80000000000000004,
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_59381748d9c4f.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager59381748d9c4f_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
